...
const InputUnlimitedPage = () => {
    ...
    return (
        <Layout>
            ...
            {!userToken ? <section className='input-page-area'>
                <div className="container">
                    <div className="row">
                        <div className="col-12 text-center">
                            <h2 className='mb-4 text-danger'>Your don't have allow this page!</h2>
...
export default InputUnlimitedPage;
